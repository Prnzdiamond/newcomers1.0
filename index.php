            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="latest_blog_carousel">
                     <div class="single_item single_item_first">
                        <div class="blog-img">
                            <a href="#"><img src="two/images/features/features_1.jpg" alt="" class="img-fluid"></a>
                        </div>
                    ...
                    <div class="single_item single_item_center">
                        <div class="blog-img">
                            <a href="#" title=""><img src="two/images/features/features_2.jpg" alt="" class="img-fluid"></a>
                        </div>
                        <div class="blog_title">
                            <span>Go To</span>  
                   ...
                   <div class="single_item single_item_last">
                        <div class="blog-img">
                            <a href="#" title=""><img src="two/images/features/features_3.jpg" alt="" class="img-fluid"></a>
                        </div>
                        <div class="blog_title">
                            <span>Get Your</span>  
					...
					<div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
						<div class="item">
							<div class="recent-news">
								...
								<div class="info-bx">
									<ul class="media-post">
										<li><a href="#"><i class="fas fa-calendar"></i>Jan 02 2019</a></li>
										<li><a href="#"><i class="fas fa-user"></i>By William</a></li>
									</ul>
									...
									<div class="post-extra">
										...
										<a href="#" class="comments-bx"><i class="fas fa-comments-o"></i>20 Comment</a>
									</div>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="recent-news">
								...
								<div class="info-bx">
									<ul class="media-post">
										<li><a href="#"><i class="fas fa-calendar"></i>Feb 05 2019</a></li>
										<li><a href="#"><i class="fas fa-user"></i>By John</a></li>
									</ul>
									...
									<div class="post-extra">
										<a href="#" class="btn-link">READ MORE</a>
										<a href="#" class="comments-bx"><i class="fas fa-comments-o"></i>14 Comment</a>
									</div>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="recent-news">
								...
								<div class="info-bx">
									<ul class="media-post">
										<li><a href="#"><i class="fas fa-calendar"></i>April 14 2019</a></li>
										<li><a href="#"><i class="fas fa-user"></i>By George</a></li>
									</ul>
									...
									<div class="post-extra">
										<a href="#" class="btn-link">READ MORE</a>
										<a href="#" class="comments-bx"><i class="fas fa-comments-o"></i>23 Comment</a>
									</div>
								</div>
							</div>
						</div>
