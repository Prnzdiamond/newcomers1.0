<footer>
        ...
        <div class="row">
            <div class="col-12 col-sm-3 col-md-3 col-lg-3 p-0 ">
                <div class="shape_wrapper">
                    <img src="<?php echo $file_dir; ?>assets/images/shapes/bubble_shpe_1.png" alt="" class="shape_t_1"> 
                    <img src="<?php echo $file_dir; ?>assets/images/shapes/round_shpae_1.png" alt="" class="shape_t_2">
                </div>   
            </div>
            <div class="col-12 col-sm-9 col-md-9 col-lg-9 p-0 become_techer_wrapper">
                <div class="become_a_teacher">
                    ...
                    <img src="<?php echo $file_dir; ?>assets/images/shapes/bubble_shpe_2.png" alt="" class="shape_t_1"> 
                </div>                                
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="footer_single_col footer_intro">
                        <img src="<?php echo $file_dir; ?>assets/images/logo2.png" alt="" class="f_logo">
    ...
    <img src="<?php echo $file_dir; ?>assets/images/shapes/footer_bg_shpe_1.png" alt="" class="shapes1_footer">
</footer><!-- End Footer -->
