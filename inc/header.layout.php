<!-- <header>
        ...
        <div class="container">
            <div class="row d-flex justify-content-between">
                ...
                <div class="topbar-right">
                    <ul>
                        <li>
                            <select class="header-lang-bx bs-select-hidden">
                                <option data-icon="flag flag-uk">English UK</option>
                                <option data-icon="flag flag-us">English US</option>
                            </select>
                            <div class="btn-group bootstrap-select header-lang-bx">
                                <button type="button" class="btn dropdown-toggle btn-default" data-toggle="dropdown" title="English UK" aria-expanded="false">
                                    <span class="filter-option pull-left"><i class="glyphicon flag flag-uk"></i> English UK</span>
                                    &nbsp;<span class="caret fa fa-caret-down"></span>
                                </button>
                                <div class="dropdown-menu open" x-placement="bottom-start" style="max-height: 522.141px; overflow: hidden; min-height: 0px; position: absolute; transform: translate3d(0px, 20px, 0px); top: 0px; left: 0px; will-change: transform;"><ul class="dropdown-menu inner" role="menu" style="max-height: 520.141px; overflow-y: auto; min-height: 0px;">
                                <ul>
                                <li data-original-index="0" class="selected">
                                    <a tabindex="0" class="" data-tokens="null">
                                        <span class="glyphicon flag flag-uk"></span> 
                                ...
                                <li data-original-index="1">
                                    <a tabindex="0" class="" data-tokens="null">
                                        <span class="glyphicon flag flag-us"></span> 
    ...
    <link rel="shortcut icon" href="<?php echo $file_dir; ?>assets/favicon/favicon.ico" type="image/x-icon">
    <!-- Goole Font -->
